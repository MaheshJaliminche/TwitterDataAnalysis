...
public class CoOccurenceStripesCount {

	private static final transient Logger LOG = LoggerFactory.getLogger(CoOccurenceStripesCount.class);
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(CoOccurenceStripesCount.class);
