...
public class CoOccurencePairCount {

	private static final transient Logger LOG = LoggerFactory.getLogger(CoOccurencePairCount.class);
	...
	public static void main(String[] args) throws Exception {
		...
		while(w<2)
		{
			if(w==0)
			{
				...
				//MR to calculate total reoccurence count
				job.setJarByClass(CoOccurencePairCount.class);
